...
from WriteSTORMBin_XcYcZZcFrame import write_storm_bin_XcYcFramedisAngledisxy
from disp_angle_calculator_pickone2 import disp_angle_calculator_Z
import time
import wx
...
for file_path in file_path_list:
    ...
    result_array_disp_xy = np.zeros(estimated_total_num,dtype=np.float32)
    ...
    original_mol_Zc = np.float32(original_mol_list['Zc'])
        ...
        if original_mol_Frame[frame_index_cursor_D]==frame_cursor:
            ...
            if frame_index_cursor_B == frame_index_cursor_C:
                ...
                correlate_num, return_array_x_start, return_array_y_start,return_array_x_end, \
                    return_array_y_end,return_array_frame, return_array_disp, return_array_angle, return_array_disp_xy \
                        = disp_angle_calculator_Z(original_mol_Xc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Yc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Zc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Xc[frame_index_cursor_C:frame_index_cursor_D],
                                      original_mol_Yc[frame_index_cursor_C:frame_index_cursor_D],
                                      original_mol_Zc[frame_index_cursor_C:frame_index_cursor_D],
                                      frame_index_cursor_B-frame_index_cursor_A,
                                      frame_index_cursor_D-frame_index_cursor_C,
                                      disp_thre,frame_cursor-2,pixel_size)
                ...
                result_array_angle[result_array_start_index:result_array_start_index+correlate_num] \
                    = return_array_angle
                result_array_disp_xy[result_array_start_index:result_array_start_index+correlate_num] \
                    = return_array_disp_xy
    ...
    result_array_disp_xy_2 = np.zeros(estimated_total_num,dtype=np.float32)
        ...
        if original_mol_Frame[frame_index_cursor_D]==frame_cursor:
            ...
            if frame_index_cursor_B == frame_index_cursor_C:
                ...
                correlate_num, return_array_x_start_2, return_array_y_start_2,return_array_x_end_2, \
                    return_array_y_end_2,return_array_frame_2, return_array_disp_2, return_array_angle_2, return_array_disp_xy_2 \
                        = disp_angle_calculator_Z(original_mol_Xc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Yc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Zc[frame_index_cursor_A:frame_index_cursor_B],
                                      original_mol_Xc[frame_index_cursor_C:frame_index_cursor_D],
                ...
                result_array_disp_xy_2[result_array_start_index_2:result_array_start_index_2+correlate_num] \
                    = return_array_disp_xy_2
    ...
    save_file_path = file_path.replace('.bin','-dis'+str(disp_thre)+'Z.bin')
    
    write_storm_bin_XcYcFramedisAngledisxy(save_file_path, total_frame, result_array_start_index+result_array_start_index_2, 
                                 ...
                                 np.hstack((result_array_disp_xy[0:result_array_start_index],result_array_disp_xy_2[0:result_array_start_index_2])))
