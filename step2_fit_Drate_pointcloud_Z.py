...
from hist_maker_PCA_shrinkbinrange import hist_maker_Z
...
if __name__=="__main__":
    ...
    image_bin_size = 1 # unit is pixel
    ...
    mode_trigger = 1
    disp_thre = 5
    time_interval = 0.0068  # unit is s, so 1 ms
    ...
    for file_path in file_path_list:
        ...
        with Pool(processes = cpu_count()) as pool:
            averaged_hist_array = pool.map(partial(hist_maker_Z,disp_thre=disp_thre,
